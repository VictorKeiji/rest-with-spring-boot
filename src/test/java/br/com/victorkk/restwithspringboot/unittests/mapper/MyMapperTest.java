package br.com.victorkk.restwithspringboot.unittests.mapper;
...
public class MyMapperTest {
    ...
    public void parseEntityToVOTest() {
        PersonVO output = MyMapper.INSTANCE.personToPersonVO(inputObject.mockEntity());
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = MyMapper.INSTANCE.parseListPersonVOs(inputObject.mockEntityList());
    ...
    public void parseVOToEntityTest() {
        Person output = MyMapper.INSTANCE.personVOToPerson(inputObject.mockVO());
        //(Long.valueOf(0L), output.getId());
        assertEquals("First Name Test0", output.getFirstName());
        assertEquals("Last Name Test0", output.getLastName());
        assertEquals("Addres Test0", output.getAddress());
        assertEquals("M", output.getGender());
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = MyMapper.INSTANCE.parseListPersons(inputObject.mockVOList());
